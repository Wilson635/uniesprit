<!DOCTYPE html>
<html lang="en" dir="ltr" data-color-theme="Blue_Theme"
...
<main>
    ...
    <div id="main-wrapper" class="flex">
        <aside id="application-sidebar-brand"
                ...
                <div class="brand-logo flex  items-center ">
                    <a href="../main/index.html" class="text-nowrap logo-img">
                        <img
                                ...
                                class="dark:hidden block rtl:hidden !w-fit"
                                alt="Logo-Dark"
                        />
                        <img
                        ...
                        <img
                                src="../assets/images/logos/dark-logo-rtl.svg"
                                class="dark:hidden hidden rtl:block rtl:dark:hidden !w-fit"
                                alt="Logo-Dark"
                        />
                        <img
                                src="../assets/images/logos/light-logo-rtl.svg"
                        ...
                        <nav class="hs-accordion-group w-full flex flex-col">
                            <ul data-te-sidenav-menu-ref id="sidebarnav">
                                ...
                                <div
                                        class="caption">
                                    <i
                                            class="ti ti-dots nav-small-cap-icon "></i>
                                    <span class="hide-menu">Home</span>
                                </div>
                                <li class="sidebar-item">
                                    <a
                                            class="sidebar-link dark-sidebar-link
          "
                                            href="../main/index.html">
                                        <i class="ti ti-brand-chrome  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Modern</span>
                                    </a>
                                </li>
          ...
          "
                                        ...
                                        <i class="ti ti-shopping-cart  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">eCommerce</span>
                                    </a>
                                </li>
          ...
          "
                                        ...
                                        <i class="ti ti-currency-dollar  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">NFT</span>
                                    </a>
                                </li>
          ...
          "
                                        ...
                                        <i class="ti ti-cpu  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Crypto</span>
                                    </a>
                                </li>
          ...
          "
                                        ...
                                        <i class="ti ti-activity-heartbeat  text-xl flex-shrink-0"></i>
          ...
          "
                                        ...
                                        <i class="ti ti-playlist  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Music</span>
                                    </a>
                                </li>
                                <li
                                        class="hs-accordion sidebar-item "
                                        id="blog-accordion">
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-app-window text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Frontend Pages</span>
                                        ...
                                        <ul class>
                                            <li class="pl-4 pr-3">
                                                <a
                                                        ...
                                                        href="../main/frontend-homepage.html">
                                                    <i
                                                            class="ti ti-circle flex-shrink-0 text-xs me-3 "></i>
                                            ...
                                            <li class="pl-4 pr-3">
                                                <a
                                                    ...
                                                    <i
                                                            class="ti ti-circle flex-shrink-0 text-xs me-3 "></i>
                                                    <span class="hide-menu">Blog Detail</span>
                                                </a>
                                            </li>
                                            <li class="pl-4 pr-3">
                                                <a
          ...
          "
                                        ...
                                        <i class="ti ti-calendar  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Calendar</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-ti ti-layout-kanban  text-xl flex-shrink-0"></i>
                                        <span class="hide-menu flex-shrink-0">Kanban</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-message-dots text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Chat</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-mail text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Email</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-notes text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Notes</span>
                                    </a>
                                </li>
          ...
          "
                                        ...
                                        <i class="ti ti-phone  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Contact Table</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-list-details text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Contact List</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-file-text text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Invoice</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-user-circle text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">User Profile</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    ...
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-chart-donut-3 text-xl flex-shrink-0"></i> <span
              ...
              <i
                      class="ti ti-chevron-up text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative"></i>
                                ...
                                <li
                                    ...
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-basket text-xl flex-shrink-0"></i> <span
              ...
              <i
                      class="ti ti-chevron-up text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative"></i>
                                ...
                                <li
                                    ...
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-layout-grid text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Ui Elements</span>
                                        <span class="hide-menu ms-auto">
              <i
                      class="ti ti-chevron-down text-lg ms-auto  hs-accordion-active:hidden "></i>
              <i
                      class="ti ti-chevron-up text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative"></i>
                                ...
                                <li
                                        class="hs-accordion  sidebar-item   active "
                                        id="ui-card">
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link   active dropdown-menu-active dark:text-white ">
                                        <i class="ti ti-cards text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Cards</span>
                                        <span class="hide-menu ms-auto">
              <i
                      class="ti ti-chevron-down text-lg ms-auto  hs-accordion-active:hidden "></i>
              <i
                      class="ti ti-chevron-up text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative"></i>
                                    ...
                                    <div id="ui-card"
                                         class="hs-accordion-content  active-menu h-full ">
                                        <ul class>
                                            <li class="pl-4 pr-3">
                                                <a
                                                        class="dropdown-submenu-link "
                                                        href="../main/ui-cards.html">
                                                    <i
                                                            class="ti ti-circle flex-shrink-0 text-xs me-3 "></i>
                                            ...
                                            <li class="pl-4 pr-3">
                                                <a
                                                        class="dropdown-submenu-link  active text-primary dark:text-primary"
                                ...
                                <li
                                    ...
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-files text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Form Elements</span>
                                        <span class="hide-menu ms-auto">
              <i
                      class="ti ti-chevron-down text-lg ms-auto  hs-accordion-active:hidden "></i>
              <i
          ...
          "
                                        ...
                                        <i class="ti ti-currency-dollar  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Pricing</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-help  text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">FAQ</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-user-circle text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Account Setting</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-app-window text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Landing Page</span>
                                    </a>
                                </li>
                                <li
                                        class="hs-accordion sidebar-item "
                                    ...
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-layout text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Widgets</span>
                                        <span class="hide-menu ms-auto">
              <i
                      class="ti ti-chevron-down text-lg ms-auto  hs-accordion-active:hidden "></i>
              <i
          ...
          "
                                        ...
                                        <i class="ti ti-border-all text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Basic Table</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-table-row text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Highlighted Table</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-table-alias text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Miscellaneous Table</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a
          ...
          "
                                        ...
                                        <i class="ti ti-brand-airtable text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Editable Table</span>
                                    </a>
                                </li>
          ...
          "
                                        ...
                                        <i class="ti ti-database text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Basic Data Table</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    ...
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-chart-pie text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Apex Charts</span>
                                        <span class="hide-menu ms-auto">
              <i
                      class="ti ti-chevron-down text-lg ms-auto  hs-accordion-active:hidden "></i>
              <i
        ...
        "
                                        ...
                                        <i class="ti ti-archive   text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Tabler</span>
                                    </a>
                                </li>
          ...
          "
                                        ...
                                        <i class="ti ti-alert-circle text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Error</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    ...
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-login text-xl flex-shrink-0"></i> <span
              ...
              <i
                      class="ti ti-chevron-up text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative"></i>
                                ...
                                <li class="hs-accordion sidebar-item " id="auth-register">
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-user-plus text-xl flex-shrink-0"></i> <span
              ...
              <i
                      class="ti ti-chevron-up text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative"></i>
                                ...
                                <li class="hs-accordion sidebar-item" id="auth-forgot">
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-rotate text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Forgot Password</span>
                                        <span class="hide-menu ms-auto">
              <i
                      class="ti ti-chevron-down text-lg ms-auto  hs-accordion-active:hidden "></i>
              <i
                      class="ti ti-chevron-up text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative"></i>
                                ...
                                <li class="hs-accordion sidebar-item" id="auth-twostep">
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-zoom-code text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Two Steps</span>
                                        <span class="hide-menu ms-auto">
              <i
                      class="ti ti-chevron-down text-lg ms-auto  hs-accordion-active:hidden "></i>
              <i
          ...
          "
                                        ...
                                        <i class="ti ti-settings text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Maintenance</span>
                                    </a>
                                </li>
                                ...
                                <div
                                        class="caption mt-8">
                                    <i
                                            class="ti ti-dots nav-small-cap-icon uppercase"></i>
        ...
        "
                                        ...
                                        <i class="ti ti-file-text text-xl flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0">Getting Started</span>
                                    </a>
                                </li>
                                ...
                                <li class="hs-accordion  sidebar-item  " id="users-accordion">
                                    <a
                                            class="hs-accordion-toggle sidebar-link dropdown-menu-link  ">
                                        <i class="ti ti-menu text-xl flex-shrink-0"></i> <span
                                                class="hide-menu">Menu Level </span>
                                        <span class="hide-menu ms-auto">
              <i
                      class="ti ti-chevron-down text-lg ms-auto  hs-accordion-active:hidden "></i>
              <i
                      class="ti ti-chevron-up text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative"></i>
                                    ...
                                    <div id="users-accordion"
                                        ...
                                        <ul class="hs-accordion-group " data-hs-accordion-always-open>
                                            <li
                                                    class="hs-accordion pl-4 pr-3 py-1 transition-colors duration-150 text-link dark:text-darklink"
                                                ...
                                                <a
                                                        class="hs-accordion-toggle py-2 w-full gap-2 flex dropdown-submenu-link"
                                                        href="#">
                                                    <i
                                                            class="ti ti-circle flex-shrink-0 me-3 text-xs"></i>
                                                    <span class="hide-menu">Level 2</span>
                                                    <span class="hide-menu ms-auto">
                    <i
                            class="ti ti-chevron-down flex-shrink-0 text-lg ms-auto  hs-accordion-active:hidden"></i>
                    <i
                            class="ti ti-chevron-up flex-shrink-0 text-lg ms-auto hs-accordion-active:block ml-auto hidden z-10 relative "></i>
                  </span>
                                                </a>

                                                <div id="users-accordion-sub-1"
                                                     class="hs-accordion-content second-level">
                                                    <ul class>
                                                        <li class>
                                                            <a
                                                                    class="w-full py-2 flex gap-2  dropdown-submenu-link"
                                                                    href="#">
                                                                <i
                                                                        class="ti ti-circle flex-shrink-0 me-3 text-xs "></i>
                                ...
                                <li>
                                    <a
                                            class=" px-3 py-[8px] rounded-md text-link dark:text-darklink w-full flex items-center text-sm opacity-50"
                                            href="#">
                                        <i class="ti ti-circle-off flex-shrink-0  me-3 text-xl"></i> <span
           ...
           "
            ...
            <span class="flex items-center">
              <i class="ti ti-star flex-shrink-0 me-3 text-xl"></i>
           ...
           "
                                            href="#">
                                        <i class="ti ti-star flex-shrink-0 text-xl"></i>
                    ...
                    <div class="hide-menu ">
                        <div class="flex items-center">
                            <img src="../assets/images/profile/user-1.jpg"
                                 class="h-9 w-9 rounded-full object-cover" alt="profile"/>
                            <div class="ml-4 rtl:mr-4 rtl:ml-0">
                                <h5
                                        class="text-base font-semibold text-dark dark:text-white">Mathew</h5>
                                <p
                                        class="text-xs font-normal text-link dark:text-darklink ">Designer</p>
                            </div>
        ...
        <div class="page-wrapper w-full" role="main">
            ...
            <header
                                                ...
                                                <div class="lg:p-0 p-5 lg:flex gap-2 items-center">
                                                    <div class="lg:flex items-center">
                                                        <div class="hs-dropdown lg:py-4  [--strategy:static] lg:[--strategy:absolute] [--adaptive:none] sm:[--trigger:hover] relative group/menu">
                                                            ...
                                                            <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 left-0 hidden z-10 sm:mt-3 top-full start-0 min-w-[15rem] lg:w-[900px] before:absolute lg:bg-white bg-transparent dark:bg-dark lg:shadow-md shadow-none">
                ...
                <div class="with-horizontal w-full">
                    <div
                            class="bg-white dark:bg-dark shadow-md dark:shadow-dark-md">
                        <div class="container">
            ...
            <aside class="with-horizontal lg:flex hidden">
                <nav class="relative border-b border-border dark:border-darkborder py-4">
                    ...
                    " href="../main/index.html">
                                        <i class="ti ti-brand-chrome text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Modern</span>
                                    </a>
                                    <a class="horizontal-link
                    " href="../main/index2.html">
                                        <i class="ti ti-shopping-cart text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">eCommerce</span>
                                    </a>
                                    <a class="horizontal-link
                    " href="../main/index3.html">
                                        <i class="ti ti-currency-dollar text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">NFT</span>
                                    </a>
                                    <a class="horizontal-link
                    " href="../main/index4.html">
                                        <i class="ti ti-cpu text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Crypto</span>
                                    </a>
                                    <a class="horizontal-link
                    " href="../main/index5.html">
                                        <i class="ti ti-activity-heartbeat text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">General</span>
                                    </a>
                                    <a class="horizontal-link
                    " href="../main/index6.html">
                                        <i class="ti ti-playlist text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Music</span>
                                    </a>
                                </div>
                            </div>
            ...
            ">
                                ...
                                <div
                                        class="py-4 px-3 hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 left-0 hidden z-10 sm:mt-4 top-full start-0 min-w-[400px]  before:absolute lg:bg-white bg-transparent dark:bg-dark lg:shadow-md shadow-none">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/app-calendar.html">
                                                <i class="ti ti-calendar text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Calendar</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/app-kanban.html">
                                                <i class="ti ti-layout-kanban text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Kanban</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/app-chat.html">
                                                <i class="ti ti-message-dots text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Chat</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/app-email.html">
                                                <i class="ti ti-mail text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Email</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/app-contact.html">
                                                <i class="ti ti-phone text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Contact Table</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/app-contact2.html">
                                                <i class="ti ti-list-details text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Contact List</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/app-notes.html">
                                                <i class="ti ti-notes text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Notes</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/app-invoice.html">
                                                <i class="ti ti-file-text text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Invoice</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/page-user-profile.html">
                                                <i class="ti ti-user-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">User Profile</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/blog-posts.html">
                                                <i class="ti ti-article text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Posts</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/blog-detail.html">
                                                <i class="ti ti-article text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Details</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/eco-shop.html">
                                                <i class="ti ti-shopping-cart text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Shop</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/eco-shop-detail.html">
                                                <i class="ti ti-basket text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Shop Detail</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/eco-product-list.html">
                                                <i class="ti ti-list-check text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">List</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                        " href="../main/eco-checkout.html">
                                                <i class="ti ti-brand-shopee text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Checkout</span>
                                            </a>
                                        </div>
               ...
               ">
                                ...
                                <div
                                        class="py-4 px-3 hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 left-0 hidden horizontal-items">
                                    <a class="horizontal-link
               " href="../main/page-faq.html">
                                        <i class="ti ti-help text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">FAQ</span>
                                    </a>
                                    <a class="horizontal-link
               " href="../main/page-account-settings.html">
                                        <i class="ti ti-user-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Account Setting</span>
                                    </a>
                                    <a class="horizontal-link
               " href="../main/page-pricing.html">
                                        <i class="ti ti-currency-dollar text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Pricing</span>
                                    </a>
                                    <a class="horizontal-link
               " href="../main/widgets-cards.html">
                                        <i class="ti ti-cards text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Cards</span>
                                    </a>
                                    <a class="horizontal-link
               " href="../main/widgets-banners.html">
                                        <i class="ti ti-ad text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Banner</span>
                                    </a>
                                    <a class="horizontal-link
               " href="../main/widgets-charts.html">
                                        <i class="ti ti-chart-bar text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Charts</span>
                                    </a>
                                    <a class="horizontal-link
               " href="../landingpage/index.html">
                                        <i class="ti ti-app-window text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Landing Page</span>
                                    </a>
            ...
            ">
                                ...
                                <div
                                        class="py-4 px-3 hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 left-0 hidden z-10 sm:mt-4 top-full start-0 w-full  before:absolute lg:bg-white bg-transparent dark:bg-dark lg:shadow-md shadow-none">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-accordion.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Accordion</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-badge.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Badge</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-button.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Button</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-dropdowns.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Dropdowns</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-modals.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Modals</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-tab.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Tab</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-tooltip-popover.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Tooltip & Popover</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-notification.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Notification</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-progressbar.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Progressbar</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-pagination.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Pagination</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-typography.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Typography</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-breadcrumb.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Breadcrumb</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-offcanvas.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Offcanvas</span>
                                            </a>
                                        </div>
                        ...
                        " href="../main/ui-lists.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Lists</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-grid.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Grid</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-carousel.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Carousel</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-scrollspy.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Scrollspy</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-spinner.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Spinner</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-link.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Link</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-chat-bubbles.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Chat Bubbles</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-datepicker.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Datepicker</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-devices.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Devices</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-ratings.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Ratings</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-stepper.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Stepper</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-timeline.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Timeline</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-toasts.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Toasts</span>
                                            </a>
                                        </div>
                                        <div class="col-span-3">
                                            <a class="horizontal-link
                        " href="../main/ui-skeleton.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Skeleton</span>
                                            </a>
                                        </div>
                                    </div>
                ...
                ">
                            ...
                            " href="../main/form-inputs.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Forms Input</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                            " href="../main/form-input-groups.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Input Groups</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                            " href="../main/form-checkbox-radio.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Checkbox & Radios</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                            " href="../main/form-input-grid.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Input Grid</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                            " href="../main/form-input-number.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Input Number</span>
                                            </a>
                                        </div>
                                        <div class="col-span-6">
                                            <a class="horizontal-link
                            " href="../main/form-advanced-password.html">
                                                <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                        class="hide-menu flex-shrink-0 text-sm leading-tight">Advanced Password</span>
                                            </a>
                                        </div>
                                    </div>
                   ...
                   " href="../main/table-basic.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Basic Table</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/table-layout-highlighted.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Highlighted Table</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/table-miscellaneous.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Miscellaneous Table</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/table-editable.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Editable Table</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/table-datatable-basic.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Basic Data Table</span>
                                    </a>
                   ...
                   " href="../main/chart-apex-line.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Line Chart</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/chart-apex-area.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Area Chart</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/chart-apex-bar.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Bar Chart</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/chart-apex-pie.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Pie Chart</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/chart-apex-radial.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Radial Chart</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="../main/chart-apex-radar.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Radar Chart</span>
                                    </a>
                                </div>
                            </div>
                            <div
                   ...
                   " href="../main/icon-tabler.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Tabler icon</span>
                                    </a>
                                </div>
                            </div>
                            <div
                   ...
                   " href="../docs/index.html">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Documentation</span>
                                    </a>
                                    <a class="horizontal-link
                   " href="#">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Page 1</span>
                                    </a>
                                    <div
                   ...
                   " href="#">
                                        <i class="ti ti-circle text-base flex-shrink-0"></i> <span
                                                class="hide-menu flex-shrink-0 text-sm leading-tight">Page 3</span>
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <main class="pt-6">
                <div class="container full-container py-5">
                        ...
                        <div class="card-body md:py-3 py-5">
                            <div class=" items-center grid grid-cols-12 gap-6">
                                <div class="col-span-9">
                                    <h4 class="font-semibold text-xl text-dark dark:text-white mb-3">Custom Cards</h4>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-6">
                        <div
                                class="lg:col-span-2 md:col-span-4 col-span-6">
                            <div id="dismiss-alert1"
                                 class="card hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 "
                                 role="alert">
                                <div class="card-body text-center">
                                    <button type="button"
                                        ...
                                        <i
                                                class="ti ti-x text-xl text-bodytext dark:text-darklink"></i>
                                    </button>
                                    <img
                                            src="../assets/images/profile/user-5.jpg"
                                            width="75"
                                            class="rounded-full mx-auto my-3"/>
                                    <h5
                                            class="font-medium text-lg mb-1 text-dark dark:text-white">John
                                        Deo</h5>
                                    <div
                                            class="bg-lightsuccess dark:bg-darksuccess text-success px-3 text-sm py-1 w-fit rounded-md mx-auto">
                                        active
                                    </div>
                                    <button
                                            class="btn bg-lightsuccess dark:bg-darksuccess text-success w-full px-4 hover:bg-success hover:text-white  dark:hover:bg-success dark:hover:text-white  mx-auto mt-4">
                                        Message
                                    </button>
                                </div>
                            </div>
                            ...
                            <div id="dismiss-alert2"
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5
                                        ...
                                        Deo</h5>
                                    <div
                                            class="bg-lightwarning dark:bg-darkwarning text-warning px-3 text-sm py-1 w-fit rounded-md mx-auto">
                                        away
                                    </div>
                                    <button
                                            class="btn bg-lightwarning dark:bg-darkwarning text-warning w-full px-4 hover:bg-warning hover:text-white  dark:hover:bg-warning dark:hover:text-white  mx-auto mt-4">
                                        Message
                                    </button>
                                </div>
                            </div>
                            ...
                            <div id="dismiss-alert4"
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5
                                        ...
                                        Deo</h5>
                                    <div
                                            class="bg-lightsecondary dark:bg-darksecondary text-secondary px-3 text-sm py-1 w-fit rounded-md mx-auto">
                                        offline
                                    </div>
                                    <button
                                            class="btn bg-lightsecondary dark:bg-darksecondary text-secondary w-full px-4 hover:bg-secondary hover:text-white  dark:hover:bg-secondary dark:hover:text-white  mx-auto mt-4">
                                        Message
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="-mt-2 text-center">
                                                <span
                                                        class="bg-primary text-white text-sm  w-fit badge-md font-medium">Editor</span>
                                        <h3
                                                class="text-lg font-medium mt-3">Matt
                                            Carlson</h3>
                                        <h6 class=" font-medium">San
                                            Francisco, CA</h6>
                                    </div>
                                    <div
                                            class="grid md:grid-cols-2 grid-cols-2 mt-4 gap-5">
                                        <div
                                                class="bg-lightgray dark:bg-darkprimary rounded-full flex items-center gap-2 px-4 py-2">
                                            <i
                                                    class="ti ti-star text-3xl text-warning"></i>
                                            <div>
                                                <h6
                                                        class="font-light">Reviews</h6>
                                                <h4
                                                        class="text-lg font-medium leading-tight text-dark dark:text-white">
                                                    368</h4>
                                            </div>
                                        </div>
                                        <div
                                                class="bg-lightgray dark:bg-darkprimary rounded-full flex items-center gap-2 px-4 py-2">
                                            <i
                                                    class="ti ti-brand-google-photos text-3xl text-primary"></i>
                                            <div>
                                                <h6
                                                        class="font-light">Photos</h6>
                                                <h4
                                                        class="text-lg font-medium leading-tight text-dark dark:text-white">
                                                    1200</h4>
                                            </div>
                        ...
                        <div
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="-mt-2 text-center">
                                                <span
                                                        class="bg-error text-white text-sm  w-fit badge-md font-medium">Developer</span>
                                        <h3
                                                class="text-lg font-medium mt-3">Matt
                                            Carlson</h3>
                                        <h6 class=" font-medium">San
                        ...
                        <div
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="-mt-2 text-center">
                                                <span
                                                        class="bg-warning text-white text-sm  w-fit badge-md font-medium">Designer</span>
                                        <h3
                                                class="text-lg font-medium mt-3">Matt
                                            Carlson</h3>
                                        <h6 class=" font-medium">San
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div
                                        ...
                                        <div>
                                            <h5
                                                    class="card-title">Social
                                                Marketing</h5>
                                            <p class="card-subtitle">65,450
                                                sales</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        <div
                                            ...
                                            <i
                                                    class="ti ti-brand-dribbble  text-3xl text-primary"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="text-lg font-medium">Dribble</h5>
                                            <p
                                                    class="text-sm ">Ecommerce
                                                Design, App Design</p>
                                        </div>
                                    </div>
                                    <hr
                                            class="border-t border-border dark:border-darkborder
 my-4"/>
                                    <div class="flex gap-4">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lighterror dark:bg-darkerror rounded-md">
                                            <i
                                                    class="ti ti-brand-youtube  text-3xl text-error"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="text-lg font-medium">Youtube</h5>
                                            <p class="card-subtitle">Waiting
                                                for new videos</p>
                                        </div>
                                    </div>
                                    <hr
 ...
 my-4"/>
                                    <div class="flex gap-4">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightinfo dark:bg-darkinfo rounded-md">
                                            <i
                                                    class="ti ti-brand-messenger text-3xl text-info"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="text-lg font-medium">Messanger</h5>
                                            <p class="card-subtitle">4 new
                                                notifcations</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightinfo dark:bg-darkinfo rounded-md">
                                            <i
                                                    class="ti ti-brand-drops  text-3xl text-info"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="card-title">Dropbox</h5>
                                            <p class="card-subtitle">wainting
                                                for 2 new uploads</p>
                                        </div>
                                    </div>
                                    <hr
 ...
 my-4"/>
                                    <div class="flex gap-4">
                                        <div
                                            ...
                                            <i
                                                    class="ti ti-brand-google-drive  text-3xl text-warning"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="card-title">Drive</h5>
                                            <p class="card-subtitle">Waiting
                                                for new videos</p>
                                        </div>
                                    </div>
 ...
 my-4"/>
                                    <div class="flex gap-4">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightsecondary dark:bg-darksecondary rounded-md">
                                            <i
                                                    class="ti ti-brand-soundcloud text-3xl text-secondary"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="card-title">One
                                                Drive</h5>
                                            <p class="card-subtitle">Add new
                                                photos, videos</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <div>
                                            <h5
                                                    class="card-title">Yearly
                                                Sales</h5>
                                            <p class="card-subtitle">50,050
                                                sales</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightprimary dark:bg-darkprimary rounded-md">
                                            <i
                                                    class="ti ti-users  text-3xl text-primary"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="card-title">Top
                                                Designers</h5>
                                            <p class="card-subtitle">John
                                                Smith, Nancy Deo</p>
                                        </div>
                                    </div>
                                    <hr
 ...
 my-4"/>
                                    <div class="flex gap-4">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightinfo dark:bg-darkinfo rounded-md">
                                            <i
                                                    class="ti ti-chart-pie text-3xl text-info"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="card-title">Top
                                                sales</h5>
                                            <p class="card-subtitle">January,
                                                March, December</p>
                                        </div>
                                    </div>
                                    <hr
 ...
 my-4"/>
                                    <div class="flex gap-4">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightsuccess dark:bg-darksuccess rounded-md">
                                            <i
                                                    class="ti ti-message  text-3xl text-success"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="card-title">Best
                                                sellers</h5>
                                            <p class="card-subtitle">Maria
                                                Rodriguez, Maria
                                                Garcia</p>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightwarning dark:bg-darkwarning rounded-md">
                                            <i
                                                    class="ti ti-basket text-3xl text-warning"></i>
                                        </div>
                                        <div class="text-end">
                                            <h5
                                                    class="card-title">+259</h5>
                                ...
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightprimary dark:bg-darkprimary rounded-md">
                                            <i
                                                    class="ti ti-chart-pie text-3xl text-primary"></i>
                                        </div>
                                        <div class="text-end">
                                            <h5
                                                    class="card-title">750$</h5>
                                            <p
                                                    class="font-medium">Weekly
                                                Income</p>
                                        </div>
                                    </div>
                                    <div
                                ...
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lighterror dark:bg-darkerror rounded-md">
                                            <i
                                                    class="ti ti-user-plus text-3xl text-error"></i>
                                        </div>
                                        <div class="text-end">
                                            <h5
                                                    class="card-title">+6.5K</h5>
                                ...
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightsuccess dark:bg-darksuccess rounded-md">
                                            <i
                                                    class="ti ti-bell text-3xl text-success"></i>
                                        </div>
                                        <div class="text-end">
                                            <h5
                                                    class="card-title">156</h5>
                                            <p class="font-medium">New
                                                Notifications</p>
                                        </div>
                                    </div>
                                    <div
                                            class="flex w-full h-1.5 bg-lightsuccess dark:bg-darksuccess rounded-md overflow-hidden mt-4"
                                            role="progressbar"
                                            aria-valuenow="25"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                                        <div
                                                class="flex flex-col justify-center overflow-hidden bg-success text-xs text-white text-center whitespace-nowrap transition duration-500 "
                                                style="width: 25%"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        ...
                                        <div class="text-end">
                                            <h5
                                                    class="card-title">15+</h5>
                                            <p
                                                    class="font-medium">Latest
                                                Messages</p>
                                        </div>
                                    </div>
                                    <div
                                            class="flex w-full h-1.5 bg-lightinfo dark:bg-darkinfo rounded-md overflow-hidden mt-4"
                                            role="progressbar"
                                            aria-valuenow="25"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                                        <div
                                                class="flex flex-col justify-center overflow-hidden bg-info text-xs text-white text-center whitespace-nowrap transition duration-500 "
                                                style="width: 25%"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        <div
                                                class="flex justify-center items-center w-14 h-[50px] bg-lightsecondary dark:bg-darksecondary rounded-md">
                                            <i
                                                    class="ti ti-brand-drops text-3xl text-secondary"></i>
                                        </div>
                                        <div class="text-end">
                                            <h5
                                                    class="card-title">1500</h5>
                                            <p
                                                    class="font-medium">Wainting
                                                for downloads</p>
                                        </div>
                                    </div>
                                    <div
                                            class="flex w-full h-1.5 bg-lightsecondary dark:bg-darksecondary rounded-md overflow-hidden mt-4"
                                            role="progressbar"
                                            aria-valuenow="25"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                                        <div
                                                class="flex flex-col justify-center overflow-hidden bg-secondary text-xs text-white text-center whitespace-nowrap transition duration-500 "
                                                style="width: 25%"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div
                                        ...
                                        <div>
                                            <h4
                                                    class="font-light text-4xl text-dark dark:text-white">86</h4>
                                            <p class="mt-1">New
                                                Clients</p>
                                        </div>
                                        <!-- Circular Progress -->
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div
                                        ...
                                        <div>
                                            <h4
                                                    class="font-light text-4xl text-dark dark:text-white">248</h4>
                                            <p class="mt-1">All
                                                Projects</p>
                                        </div>
                                        <!-- Circular Progress -->
                                            ...
                                            <div
                                                    class="absolute top-1/2 start-1/2 transform -translate-y-1/2 -translate-x-1/2">
                                                        <span
                                                            ...
                                                            <i
                                                                    class="ti ti-briefcase text-2xl"></i></span>
                                            </div>
                                        </div>
                                        <!-- End Circular Progress -->
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div
                                        ...
                                        <div>
                                            <h4
                                                    class="font-light text-4xl text-dark dark:text-white">352</h4>
                                            <p class="mt-1"> New
                                                Items</p>
                                        </div>
                                        <!-- Circular Progress -->
                                            ...
                                            <div
                                                    class="absolute top-1/2 start-1/2 transform -translate-y-1/2 -translate-x-1/2">
                                                        <span
                                                            ...
                                                            <i
                                                                    class="ti ti-star text-2xl"></i></span>
                                            </div>
                                        </div>
                                        <!-- End Circular Progress -->
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div
                                        ...
                                        <div>
                                            <h4
                                                    class="font-light text-4xl text-dark dark:text-white">159</h4>
                                            <p class="mt-1">
                                                Invoices</p>
                                        </div>
                                        <!-- Circular Progress -->
                        ...
                        <div class="lg:col-span-4 col-span-12">
                            <div class="card ">
                                <img
                                        ...
                                        class="w-full max-w-full rounded-t-md"
                                        alt="...">
                                <div class="card-body">
                                    <div class="flex items-center mb-3">
                                                <span class="flex items-center">
                                                    <i
                                                            class="ti ti-calendar text-lg me-1"></i>
                                                    20 May 2024</span>
                                        <div class="ms-auto">
                                            <a href="javascript:void(0)"
                                               class="flex items-center hover:text-primary">
                                                <i
                                                        class="ti ti-message-circle text-lg me-1"></i>
                                                3 Comments</a>
                                        </div>
                                    </div>
                                    <h4
                                            class="text-xl font-medium ">Featured
                                        Hydroflora Pots Garden &
                                        Outdoors</h4>
                                    <p class="mt-2">Titudin venenatis
                                        ipsum ac feugiat. Vestibulum
                                        ullamcorper quam.
                                    </p>
                                    <div class="text-end mt-4"><a
                                                href="javascript:void(0)"
                                                class="btn
px-4">Read more</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="lg:col-span-4 col-span-12">
...
px-4">Read more</a></div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-6">
                        <div
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <h5
                                            class="text-xl font-medium ">26%</h5>
                                    <p>Total Product</p>
                                    <div
                                            class="flex w-full h-1.5 bg-lightsuccess dark:bg-darksuccess rounded-md overflow-hidden mt-1"
                                            role="progressbar"
                                            aria-valuenow="80"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                        ...
                        <div
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <h5
                                            class="text-xl font-medium ">60%</h5>
                                    <p>Pending Product</p>
                                    <div
                                            class="flex w-full h-1.5 bg-lightprimary dark:bg-darkprimary rounded-md overflow-hidden mt-1"
                                            role="progressbar"
                                            aria-valuenow="60"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                        ...
                        <div
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <h5
                                            class="text-xl font-medium ">63%</h5>
                                    <p>Selling Products</p>
                                    <div
                                            class="flex w-full h-1.5 bg-lighterror dark:bg-darkerror rounded-md overflow-hidden mt-1"
                                            role="progressbar"
                                            aria-valuenow="63"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                        ...
                        <div
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <h5
                                            class="text-xl font-medium ">29%</h5>
                                    <p>Buying Products</p>
                                    <div
                                            class="flex w-full h-1.5 bg-lightwarning dark:bg-darkwarning rounded-md overflow-hidden mt-1"
                                            role="progressbar"
                                            aria-valuenow="29"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                    ...
                    <!---Progress Icon with text Cards End--->

                    <!---Icon with text Cards--->
                    <div class="grid grid-cols-12 gap-6 mt-6">
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card ">
                                <div class="card-body">
                                    <div
                                        ...
                                        <div
                                                class="h-10 w-10 rounded-full bg-success flex items-center justify-center">
                                            <i
                                                    class="ti ti-credit-card text-xl text-white"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="text-xl font-medium ">$18090</h5>
                                            <p>Income</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div
                                            class="flex gap-4 items-center">
                                        <div
                                                class="h-10 w-10 rounded-full bg-info flex items-center justify-center">
                                            <i
                                                    class="ti ti-users text-xl text-white"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="text-xl font-medium ">2690</h5>
                                            <p>Users</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div
                                            class="flex gap-4 items-center">
                                        <div
                                                class="h-10 w-10 rounded-full bg-error flex items-center justify-center">
                                            <i
                                                    class="ti ti-calendar text-xl text-white"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="text-xl font-medium ">20
                                                march</h5>
                                            <p>My birthday</p>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <div
                                                class="h-10 w-10 rounded-full bg-success flex items-center justify-center">
                                            <i
                                                    class="ti ti-settings text-xl text-white"></i>
                                        </div>
                                        <div>
                                            <h5
                                                    class="text-xl font-medium ">6540</h5>
                    ...
                    <!---Icon with text Cards End--->

                    <!---Social Icon with text Cards--->
                    <div class="grid grid-cols-12 gap-6 mt-6">
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card overflow-hidden">
                                <div
                                        class="card-body py-5.5 bg-info text-center rounded-b-none text-white">
                                    <i
                                            class="ti ti-settings text-4xl"></i>
                                </div>
                                <div class="card-body">
                                    <div
                                        ...
                                        <div>
                                            <h3
                                                    class="text-xl font-medium ">456</h3>
                                            <h5
                                                    class="text-info text-base">Following</h5>
                                        </div>
                                        <div>
                                            <h3
                                                    class="text-xl font-medium ">1,456</h3>
                                            <h5
                                                    class="text-info text-base font-medium">Friends</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div
                                        class="card-body py-5.5 bg-primary text-center rounded-b-none text-white">
                                    <i
                                            class="ti ti-brand-twitter text-4xl"></i>
                                </div>
                                <div class="card-body">
                                    <div
                                            class="flex items-center justify-between">
                                        <div>
                                            <h3
                                                    class="text-xl font-medium ">456</h3>
                                            <h5
                                                    class="text-primary text-base">Twittes</h5>
                                        </div>
                                        <div>
                                            <h3
                                                    class="text-xl font-medium ">1,456</h3>
                                            <h5
                                                    class="text-primary text-base font-medium">Followers</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div
                                        class="card-body py-5.5 bg-success text-center rounded-b-none text-white">
                                    <i
                                            class="ti ti-brand-instagram text-4xl"></i>
                                </div>
                                <div class="card-body">
                                    <div
                                            class="flex items-center justify-between">
                                        <div>
                                            <h3
                                                    class="text-xl font-medium ">456</h3>
                                            <h5
                                                    class="text-success text-base">Following</h5>
                                        </div>
                                        <div>
                                            <h3
                                                    class="text-xl font-medium ">1,456</h3>
                                            <h5
                                                    class="text-success text-base font-medium">Followers</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div
                                        class="card-body py-5.5 bg-dark dark:bg-darkgray text-center rounded-b-none text-white">
                                    <i
                                            class="ti ti-brand-skype text-4xl"></i>
                                </div>
                                <div class="card-body">
                                    <div
                                            class="flex items-center justify-between">
                                        <div>
                                            <h3
                                                    class="text-xl font-medium ">456</h3>
                                            <h5
                                                    class=" text-base">Contacts</h5>
                                        </div>
                                        <div>
                                            <h3
                                                    class="text-xl font-medium ">1,456</h3>
                                            <h5
                                                    class=" text-base font-medium">Followers</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!---Social Icon with text Cards end--->

                    <!---Border Cards------>
                    <h5
                            class="card-title mt-10 ">Cards
                        With Icon</h5>
                    <div class="grid grid-cols-12 gap-6 mt-6">
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-b border-info">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <div>
                                            <h5
                                                    class="font-medium text-2xl ">120</h5>
                                            <p
                                                    class="text-info font-medium">News
                                                Feed</p>
                                        </div>
                                        <i
                                                class="ti ti-file-text text-info text-4xl"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-b border-primary">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <div>
                                            <h5
                                                    class="font-medium text-2xl ">150</h5>
                                            <p
                                                    class="text-primary font-medium">Invoices</p>
                                        </div>
                                        <i
                                                class="ti ti-clipboard text-primary text-4xl"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-b border-success">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <div>
                                            <h5
                                                    class="font-medium text-2xl ">450</h5>
                                            <p
                                                    class="text-success font-medium">Revenue</p>
                                        </div>
                                        <i
                                                class="ti ti-credit-card text-success text-4xl"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-b border-error">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <div>
                                            <h5
                                                    class="font-medium text-2xl ">100</h5>
                                            <p
                                                    class="text-error font-medium">Sales</p>
                                        </div>
                                        <i
                                                class="ti ti-chart-pie text-error text-4xl"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-s border-error">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <i
                                                class="ti ti-users text-error text-4xl"></i>
                                        <div
                                                class="ms-auto sm:text-start text-end">
                                            <h5
                                                    class="font-medium text-2xl ">290</h5>
                                            <p
                                                    class="text-error font-medium">New
                                                Customers</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-s border-info">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <i
                                                class="ti ti-message-circle text-info text-4xl"></i>
                                        <div
                                                class="ms-auto sm:text-start text-end">
                                            <h5
                                                    class="font-medium text-2xl ">120</h5>
                                            <p
                                                    class="text-info font-medium">New
                                                Messages </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-s border-primary">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <i
                                                class="ti ti-bell text-primary text-4xl"></i>
                                        <div
                                                class="ms-auto sm:text-start text-end">
                                            <h5
                                                    class="font-medium text-2xl ">600</h5>
                                            <p
                                                    class="text-primary font-medium">New
                                                Notification </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-s border-success">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <i
                                                class="ti ti-briefcase text-success text-4xl"></i>
                                        <div
                                                class="ms-auto sm:text-start text-end">
                                            <h5
                                                    class="font-medium text-2xl ">270</h5>
                                            <p
                                                    class="text-success font-medium">New
                                                Projects </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-t border-success">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <div>
                                            <h5
                                                    class="font-medium text-2xl ">120</h5>
                                            <p
                                                    class="text-success font-medium">Top
                                                Locations</p>
                                        </div>
                                        <i
                                                class="ti ti-map text-success text-4xl"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-t border-base-400">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <div>
                                            <h5
                                                    class="font-medium text-2xl ">201</h5>
                                            <p
                                                    class=" font-medium">Top
                                                Activity Pages</p>
                                        </div>
                                        <i
                                                class="ti ti-archive  text-4xl"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-t border-info">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <div>
                                            <h5
                                                    class="font-medium text-2xl ">140</h5>
                                            <p
                                                    class="text-info font-medium">Top
                                                Sales</p>
                                        </div>
                                        <i
                                                class="ti ti-chart-bar text-info text-4xl"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-t border-primary">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <div>
                                            <h5
                                                    class="font-medium text-2xl ">160</h5>
                                            <p
                                                    class="text-primary font-medium">Top
                                                Feeds</p>
                                        </div>
                                        <i
                                                class="ti ti-rss text-primary text-4xl"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-e border-base-400">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <i
                                                class="ti ti-cast  text-4xl"></i>
                                        <div
                                                class="ms-auto sm:text-start text-end">
                                            <h5
                                                    class="font-medium text-2xl ">360</h5>
                                            <p
                                                    class=" font-medium">Device
                                                Variations</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-e border-info">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <i
                                                class="ti ti-currency-dollar text-info text-4xl"></i>
                                        <div
                                                class="ms-auto sm:text-start text-end">
                                            <h5
                                                    class="font-medium text-2xl ">120</h5>
                                            <p
                                                    class="text-info font-medium">Net
                                                Income</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-e border-primary">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <i
                                                class="ti ti-clock-hour-4 text-primary text-4xl"></i>
                                        <div
                                                class="ms-auto sm:text-start text-end">
                                            <h5
                                                    class="font-medium text-2xl ">471</h5>
                                            <p
                                                    class="text-primary font-medium">Sales
                                                Performance</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card border-e border-success">
                                <div class="card-body">
                                    <div
                                            class="flex justify-between items-center">
                                        <i
                                                class="ti ti-box-multiple text-success text-4xl"></i>
                                        <div
                                                class="ms-auto sm:text-start text-end">
                                            <h5
                                                    class="font-medium text-2xl ">150</h5>
                                            <p
                                                    class="text-success font-medium">Monthly
                                                Sales</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <h5
                            class="text-lg mt-10 card-title">Cards
                        With Propgressbar & Icon</h5>
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        <div>
                                            <h5
                                                    class="text-xl font-medium ">86%</h5>
                                            <p>Total
                                                Product</p>
                                        </div>
                                        <i
                                                class="ti ti-box text-success text-4xl"></i>
                                    </div>
                                    <div
                                            class="flex w-full mt-4 h-1.5 bg-lightsuccess dark:bg-darksuccess rounded-md overflow-hidden"
                                            role="progressbar"
                                            aria-valuenow="85"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        <div>
                                            <h5
                                                    class="text-xl font-medium ">40%</h5>
                                            <p>Pending
                                                Product</p>
                                        </div>
                                        <i
                                                class="ti ti-cast text-info text-4xl"></i>
                                    </div>
                                    <div
                                            class="flex w-full mt-4 h-1.5 bg-lightinfo dark:bg-darkinfo rounded-md overflow-hidden"
                                            role="progressbar"
                                            aria-valuenow="40"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        <div>
                                            <h5
                                                    class="text-xl font-medium ">56%</h5>
                                            <p>Selling</p>
                                        </div>
                                        <i
                                                class="ti ti-clipboard text-primary text-4xl"></i>
                                    ...
                                    <div
                                            class="flex w-full mt-4 h-1.5 bg-lightprimary dark:bg-darkprimary rounded-md overflow-hidden"
                                            role="progressbar"
                                            aria-valuenow="56"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div class="flex justify-between">
                                        ...
                                        <i
                                                class="ti ti-copy text-error text-4xl"></i>
                                    </div>
                                    <div
                                            class="flex w-full mt-4 h-1.5 bg-lighterror dark:bg-darkerror rounded-md overflow-hidden"
                                            role="progressbar"
                                            aria-valuenow="26"
                                            aria-valuemin="0"
                                            aria-valuemax="100">
                    ...
                    <!---Cards With Propgressbar & Icon End------>

                    <!---Crypto Cards------>
                    <h5
                            class="text-lg mt-10 card-title">Crypto
                        Cards</h5>
                    <div class="grid grid-cols-12 gap-6 mt-6">
                        <div
                                class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card overflow-hidden">
                                <div
                                        class="card-body bg-dark dark:bg-darkgray">
                                    <div
                                            class="flex gap-4 items-center">
                                        <i
                                                class="ti ti-currency-ethereum text-white text-4xl"></i>
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">Ethereum</h5>
                                            <p
                                                    class="font-medium text-xl text-white">$3589.00k
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body bg-primary">
                                    <div
                                            class="flex gap-4 items-center">
                                        <i
                                                class="ti ti-currency-dogecoin text-white text-4xl"></i>
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">Dash</h5>
                                            <p
                                                    class="font-medium text-xl text-white">$900.00k
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body bg-error">
                                    <div
                                            class="flex gap-4 items-center">
                                        <i
                                                class="ti ti-currency-bitcoin text-white text-4xl"></i>
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">Bitcoin</h5>
                                            <p
                                                    class="font-medium text-xl text-white">$284.50k
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body bg-info">
                                    <div
                                            class="flex gap-4 items-center">
                                        <i
                                                class="ti ti-currency-ripple text-white text-4xl"></i>
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">Ripple</h5>
                                            <p
                                                    class="font-medium text-xl text-white">$650.80k
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">Bitcoin</h5>
                                            <p
                                                    class="font-medium text-white">Realestate
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                            class="grid grid-cols-3 text-center mt-7">
                                        <div class="text-white">
                                            <span>% 1h</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>
                                                0.12</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 24h</span>
                                            <p class><i
                                                        class="ti ti-arrow-down text-lg"></i>-1.06</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 7d</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>-20.10</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body bg-success">
                                    <div
                                            class="flex gap-4 items-center">
                                        <i
                                                class="ti ti-currency-euro text-white text-4xl"></i>
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">EOS</h5>
                                            <p
                                                    class="font-medium text-white">Banking
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="text-white">
                                            <span>% 24h</span>
                                            <p class><i
                                                        class="ti ti-arrow-down text-lg"></i>-1.00</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 7d</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>-2.08</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">Ethereum</h5>
                                            <p
                                                    class="font-medium text-white">Exchange
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="text-white">
                                            <span>% 1h</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>1.02</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 24h</span>
                                            <p class><i
                                                        class="ti ti-arrow-down text-lg"></i>-3.16</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 7d</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>-10.00</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body bg-secondary">
                                    <div
                                            class="flex gap-4 items-center">
                                        <i
                                                class="ti ti-currency-baht text-white text-4xl"></i>
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">Bitmark</h5>
                                            <p
                                                    class="font-medium text-white">Advertising
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="text-white">
                                            <span>% 1h</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>0.12</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 24h</span>
                                            <p class><i
                                                        class="ti ti-arrow-down text-lg"></i>-1.16</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 7d</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>-1s.08</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-white">Dash</h5>
                                            <p
                                                    class="font-medium text-white">Trading
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="text-white">
                                            <span>% 1h</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>1.16</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 24h</span>
                                            <p class><i
                                                        class="ti ti-arrow-down text-lg"></i>-1.10</p>
                                        </div>
                                        <div class="text-white">
                                            <span>% 7d</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>-0.08</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="lg:col-span-4 col-span-12">
                            <div class="card overflow-hidden">
                                <div
                                        class="card-body bg-lightgray dark:bg-darkprimary">
                                    <div
                                            class="flex gap-4 items-center">
                                        <i
                                                class="ti ti-diamond  text-4xl"></i>
                                        <div>
                                            <h5
                                                    class="font-medium text-xl ">GetGems</h5>
                                            <p
                                                    class="font-medium ">Exchange
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class>
                                            <span>% 1h</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>12.16</p>
                                        </div>
                                        <div class>
                                            <span>% 24h</span>
                                            <p class><i
                                        ...
                                        <div class>
                                            <span>% 7d</span>
                                            <p class><i
                                                        class="ti ti-arrow-up text-lg"></i>-2.18</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-3">
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div class="flex items-center gap-4">
                                    <div
                                            class="py-5 px-4 rounded-e-none bg-lightinfo dark:bg-darkinfo">
                                        <i
                                                class="ti ti-brand-messenger text-2xl text-info"></i>
                                    </div>
                                    <div>
                                        <h5
                                                class="font-medium text-xl text-info">$980</h5>
                                        <p>Free
                                            Messages</p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div class="flex items-center gap-4">
                                    <div
                                            class="py-5 px-4 rounded-e-none bg-lightsuccess dark:bg-darksuccess">
                                        <i
                                                class="ti ti-building-broadcast-tower text-2xl text-success"></i>
                                    </div>
                                    <div>
                                        <h5
                                                class="font-medium text-xl text-success">$18090</h5>
                                        <p>Free
                                            Internet</p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div class="flex items-center gap-4">
                                    <div
                                            class="py-5 px-4 rounded-e-none bg-lightprimary dark:bg-darkprimary">
                                        <i
                                                class="ti ti-clock-hour-3 text-2xl text-primary"></i>
                                    </div>
                                    <div>
                                        <h5
                                                class="font-medium text-xl text-primary">$18090</h5>
                                        <p>Unlimited
                                            Calls</p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div class="flex items-center gap-4">
                                    <div
                                            class="py-5 px-4 rounded-e-none bg-lightwarning dark:bg-darkwarning">
                                        <i
                                                class="ti ti-database text-2xl text-warning"></i>
                                    </div>
                                    <div>
                                        <h5
                                                class="font-medium text-xl text-warning">$18090</h5>
                                        <p>Free
                                            Data Storage</p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div
                                    ...
                                    <div
                                            class="py-5 px-4 rounded-s-none bg-lightinfo dark:bg-darkinfo">
                                        <i
                                                class="ti ti-brand-messenger text-2xl text-info"></i>
                                    </div>
                    ...
                    <!---Color icon Card --->
                    <h5
                            class="card-title mt-10 ">Title
                        With Subtitles</h5>
                    <div class="grid grid-cols-12 gap-6 mt-3">
                        <div
                                class="md:col-span-6 sm:col-span-6 col-span-12">
                            <div class="card">
                                <div class="card-body">
                                    <div
                                            class="flex items-center justify-between">
                                        <div
                                            ...
                                            <div>
                                                <h5
                                                        class="text-xl font-medium ">Total
                                                    Income</h5>
                                                <p
                                                >Income</p>
                                            </div>
                                        ...
                                        <h3
                                                class="text-2xl font-medium text-dark dark:text-white">$2900</h3>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div
                                        ...
                                        <h3
                                                class="text-2xl font-medium text-dark dark:text-white">$2690</h3>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div
                                        ...
                                        <h3
                                                class="text-2xl font-medium text-dark dark:text-white">20
                                            March</h3>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <div
                                                class="flex gap-4 items-center">
                                            <div
                                                    class="h-10 w-10 rounded-full bg-warning flex items-center justify-center">
                                                <i
                                                        class="ti ti-credit-card text-xl text-white"></i>
                                            </div>
                                            <div>
                                        ...
                                        <h3
                                                class="text-2xl font-medium text-dark dark:text-white">6540</h3>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <i
                                                        class="ti ti-credit-card text-xl text-success"></i>
                                            </div>
                                            <div>
                                                <h5
                                                        class="text-xl font-medium text-white">Total
                                                    Income</h5>
                                                <p
                                                        class="text-white opacity-60">Income</p>
                                            </div>
                                        </div>
                                        <h3
                                                class="text-2xl font-medium text-white">$2900</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                    class="h-10 w-10 rounded-full bg-white flex items-center justify-center">
                                                <i
                                                        class="ti ti-credit-card text-xl text-info"></i>
                                            </div>
                                            <div>
                                                <h5
                                                        class="text-xl font-medium text-white">Total
                                                ...
                                                <p
                                                        class="text-white opacity-60">Users</p>
                                            </div>
                                        </div>
                                        <h3
                                                class="text-2xl font-medium text-white">$2690</h3>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                    class="h-10 w-10 rounded-full bg-white flex items-center justify-center">
                                                <i
                                                        class="ti ti-credit-card text-xl text-primary"></i>
                                            </div>
                                            <div>
                                                <h5
                                                        class="text-xl font-medium text-white">Total
                                                ...
                                                <p
                                                        class="text-white opacity-60">My
                                                    birthday
                                                </p>
                                            </div>
                                        </div>
                                        <h3
                                                class="text-2xl font-medium text-white">20
                                            March</h3>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                    class="h-10 w-10 rounded-full bg-white flex items-center justify-center">
                                                <i
                                                        class="ti ti-credit-card text-xl text-error"></i>
                                            </div>
                                            <div>
                                                <h5
                                                        class="text-xl font-medium text-white">Total
                                                    Tasks</h5>
                                                <p
                                                        class="text-white opacity-60">Pending
                                                </p>
                                            </div>
                                        </div>
                                        <h3
                                                class="text-2xl font-medium text-white">6540</h3>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div class="flex items-center">
                                    <div
                                            class="p-6 rounded-e-none bg-info">
                                        <i
                                                class="ti ti-brand-messenger text-2xl text-white"></i>
                                    </div>
                                    <div
                                        ...
                                        <h3
                                                class="text-2xl font-medium ms-auto text-info">250</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div class="flex items-center">
                                    <div
                                            class="p-6 rounded-e-none bg-primary">
                                        <i
                                                class="ti ti-building-broadcast-tower text-2xl text-white"></i>
                                    </div>
                                    <div
                                            class="flex justify-between items-center px-4 w-full">
                                        <div>
                                        ...
                                        <h3
                                                class="text-2xl font-medium ms-auto text-primary">125</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div class="flex items-center">
                                    <div
                                            class="p-6 rounded-e-none bg-error">
                                        <i
                                                class="ti ti-clock-hour-3 text-2xl text-white"></i>
                                    </div>
                                    <div
                                            class="flex justify-between items-center px-4 w-full">
                                        <div>
                                            <h5
                                                    class="font-medium text-xl text-error">$18090</h5>
                                            <p
                                            >Unlimited
                                                Calls</p>
                                        </div>
                                        <h3
                                                class="text-2xl font-medium ms-auto text-error">450</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="card overflow-hidden">
                                <div class="flex items-center">
                                    <div
                                            class="p-6 rounded-e-none bg-success">
                                        <i
                                                class="ti ti-database text-2xl text-white"></i>
                                    </div>
                                    <div
                                            class="flex justify-between items-center px-4 w-full">
                                        <div>
                                        ...
                                        <h3
                                                class="text-2xl font-medium ms-auto text-success">750</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!---Group Card --->
                    <h5 class="card-title mt-10 ">Group Cards</h5>
                    <div class="grid grid-cols-12 gap-6 mt-3">
                        <div class="lg:col-span-4 md:col-span-6 col-span-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <h5 class="text-primary text-lg font-medium">Unique Visit</h5>
                                        <h3 class="font-medium text-2xl ">1200</h3>
                                        <div class="relative size-20 mx-auto mt-3 mb-5">
                                            <svg class="size-full" width="36" height="36" viewBox="0 0 36 36"
                                                ...
                                                <g class="origin-center -rotate-90 transform">
                                                    <circle cx="18" cy="18" r="16" fill="none"
                                                            class="stroke-current text-primary" stroke-width="2"
                                                            stroke-dasharray="100" stroke-dashoffset="75"></circle>
                                                </g>
                                            </svg>
                                            <!-- Percentage Text -->
                                            <div class="absolute top-1/2 start-1/2 transform -translate-y-1/2 -translate-x-1/2">
                                                    <span class="text-center text-2xl text-primary">
                                                        <i class="ti ti-user-circle text-2xl"></i></span>
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-2 text-center mt-3">
                                            <div class="border-e border-border dark:border-darkborder">
                                                <i class="ti ti-chevron-up text-xl text-success"></i>
                                                <h6 class="font-medium text-lg">12056</h6>
                                            </div>
                                            <div>
                                                <i class="ti ti-chevron-down text-xl text-error"></i>
                                                <h6 class="font-medium text-lg">145</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="lg:col-span-4 md:col-span-6 col-span-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <h5 class="text-error text-lg font-medium">Total Visit</h5>
                                        <h3 class="font-medium text-2xl ">1200</h3>
                                        <div class="relative size-20 mx-auto mt-3 mb-5">
                                            <svg class="size-full" width="36" height="36" viewBox="0 0 36 36"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <g class="origin-center -rotate-90 transform">
                                                    <circle cx="18" cy="18" r="16" fill="none"
                                                            class="stroke-current text-error" stroke-width="2"
                                                            stroke-dasharray="100" stroke-dashoffset="75"></circle>
                                                </g>
                                            </svg>
                                            <!-- Percentage Text -->
                                            <div class="absolute top-1/2 start-1/2 transform -translate-y-1/2 -translate-x-1/2">
                                                    <span class="text-center text-2xl text-error">
                                                        <i class="ti ti-star text-2xl"></i></span>
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-2 text-center mt-3">
                                            <div class="border-e border-border dark:border-darkborder">
                                                <i class="ti ti-chevron-up text-xl "></i>
                                                <h6 class="font-medium text-lg">21456</h6>
                                            </div>
                                            <div>
                                                <i class="ti ti-chevron-down text-xl text-error"></i>
                                                <h6 class="font-medium text-lg">145</h6>
                        ...
                        <div class="lg:col-span-4 md:col-span-6 col-span-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <h5 class=" text-lg font-medium">Bounce rate</h5>
                                        <h3 class="font-medium text-2xl ">1200</h3>
                                        <div class="relative size-20 mx-auto mt-3 mb-5">
                                            <svg class="size-full" width="36" height="36" viewBox="0 0 36 36"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <!-- Background Circle -->
                                                <circle cx="18" cy="18" r="16" fill="none"
                                                        class="stroke-current text-lightsuccess dark:text-darksuccess"
                                                        stroke-width="2"></circle>
                                                <!-- Progress Circle inside a group with rotation -->
                                                <g class="origin-center -rotate-90 transform">
                                                    <circle cx="18" cy="18" r="16" fill="none"
                                                            class="stroke-current text-success" stroke-width="2"
                                                            stroke-dasharray="100" stroke-dashoffset="75"></circle>
                                                </g>
                                            </svg>
                                            <!-- Percentage Text -->
                                            <div class="absolute top-1/2 start-1/2 transform -translate-y-1/2 -translate-x-1/2">
                                                    <span class="text-center text-2xl text-success">
                                                        <i class="ti ti-briefcase text-2xl"></i></span>
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-2 text-center mt-3">
                                            <div class="border-e border-border dark:border-darkborder">
...
<div id="hs-overlay-right"
    ...
    <div class="px-6 py-6" data-simplebar="" style="height: calc(100vh - 80px)">
        ...
        <div class="flex flex-row gap-3 customizer-box mb-8" role="group">
            ...
            <label class="btn btn-outline border border-border dark:border-darkborder text-primary h-full py-3 px-5 hs-dark-mode-active:text-darklink cursor-pointer"
                   for="light-layout" data-hs-theme-click-value="light"><i
                        class="icon ti ti-sun text-2xl me-2 "></i> Light</label>
            <input type="radio" class="btn-check" name="theme-layout" autocomplete="off"/>
            <label class="btn btn-outline border border-border dark:border-darkborder text-link  h-full py-3 px-5 cursor-pointer hs-dark-mode-active:text-primary"
        ...
        <div class="flex flex-row gap-3 customizer-box mb-8" role="group">
            ...
            <label class="btn btn-outline border border-border dark:border-darkborder text-link dark:text-darklink h-full py-3 px-5 cursor-pointer"
                   for="ltr-layout"><i
        ...
        <div class="flex flex-row flex-wrap gap-3 customizer-box color-pallete mb-8" role="group">
            ...
            <label class="hs-tooltip btn py-4 px-5 btn-outline border border-border dark:border-darkborder flex items-center  justify-center hs-tooltip-toggle cursor-pointer"
          ...
          Blue_Theme
            ...
            <label class="hs-tooltip hs-tooltip-toggle btn py-4 px-5 btn-outline border border-border dark:border-darkborder flex items-center  justify-center cursor-pointer"
...
<script
        src="../assets/libs/apexcharts/dist/apexcharts.min.js"></script>
