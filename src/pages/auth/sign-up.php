...
<form method="post" action="#" class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <img class="mx-auto rounded-full h-30 w-auto" src="../../../assets/logo.png" alt="Your Company">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p class="mt-10 text-center"> Already a member? Please <span> <a
                        class="text-red-500 hover:text-blue-400 font-bold" href="sign-in.php">sign in</a> </span></p>
    </div>
</form>
